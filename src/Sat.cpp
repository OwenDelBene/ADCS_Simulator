...
Sat::Sat(float mass, float length, float width, float height, glm::vec3 Pos, glm::vec3 Vel, glm::vec4 attitude, glm::vec3 rates)
{
	this->mass = mass; 

	this->stateVec = this->getStateVec(Pos, Vel, attitude, rates);
